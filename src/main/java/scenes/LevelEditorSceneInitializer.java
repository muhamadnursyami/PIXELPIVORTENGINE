    ...
    public void loadResources(Scene scene) {
        ...
        AssetPool.addSpritesheet("assets/images/fum.png",
                new Spritesheet(AssetPool.getTexture("assets/images/fum.png"),
                        17, 32, 4, 0));
        AssetPool.addSpritesheet("assets/images/musuh.png",
                new Spritesheet(AssetPool.getTexture("assets/images/musuh.png"),
                        16, 16, 2, 0));
...
//                ImGui.sameLine();
                ...
                Spritesheet musuh = AssetPool.getSpritesheet("assets/images/musuh.png");
                sprite = musuh.getSprite(1);
                id = sprite.getTexId();
                texCoords = sprite.getTexCoords();
                ImGui.pushID(uid++);
                if (ImGui.imageButton(id, spriteWidth, spriteHeight, texCoords[2].x, texCoords[0].y, texCoords[0].x, texCoords[2].y)) {
