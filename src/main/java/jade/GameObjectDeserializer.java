...
public class GameObjectDeserializer implements JsonDeserializer<GameObject> {
    ...
    @Override
    public GameObject deserialize(JsonElement jsonElement, Type typeOfT, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        for (JsonElement e : components){
            ...
            // tambah komponen ke game object
            go.addComponent(c);
        }
        return go;
    }
